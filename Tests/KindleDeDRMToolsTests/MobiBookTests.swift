...
struct MobiBookTests {
    @Test("getPidMetaInfo Test") func testGetPidMetaInfo() throws {
        guard let book1 = Bundle.module.path(forResource: "1", ofType: "azw3", inDirectory: "testdata/einkbookfiles"),
              ...
              let book4 = Bundle.module.path(forResource: "4", ofType: "azw3", inDirectory: "testdata/einkbookfiles"),
    ...
    @Test("processBook Test") func testProcessBook() throws {
        guard let nodrmbook1url = Bundle.module.url(forResource: "1", withExtension: "azw3", subdirectory: "testdata/einkbookfilesnodrm"),
              ...
              let nodrmbook4url = Bundle.module.url(forResource: "4", withExtension: "azw3", subdirectory: "testdata/einkbookfilesnodrm"),
              let nodrmbook5url = Bundle.module.url(forResource: "5", withExtension: "azw3", subdirectory: "testdata/einkbookfilesnodrm") else {
            throw TestError.pathNotFound
        }
        ...
        try mobiBook1.processBook(pidSet: .init(arrayLiteral: "vCNIml/cF7"))
        try mobiBook2.processBook(pidSet: .init(arrayLiteral: "JBJfi+WmJC"))
        try mobiBook3.processBook(pidSet: .init(arrayLiteral: "5m9pZCYOGG"))
