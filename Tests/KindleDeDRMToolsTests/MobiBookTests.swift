...
struct MobiBookTests {
    @Test("getPidMetaInfo Test") func testGetPidMetaInfo() throws {
        let book1: String = try #require(Bundle.module.path(forResource: "1", ofType: "azw3", inDirectory: "testdata/einkbookfiles"))
        let book2: String = try #require(Bundle.module.path(forResource: "2", ofType: "azw3", inDirectory: "testdata/einkbookfiles"))
        let book3: String = try #require(Bundle.module.path(forResource: "3", ofType: "azw3", inDirectory: "testdata/einkbookfiles"))
        let book4: String = try #require(Bundle.module.path(forResource: "4", ofType: "azw3", inDirectory: "testdata/einkbookfiles"))
        let book5: String = try #require(Bundle.module.path(forResource: "5", ofType: "azw3", inDirectory: "testdata/einkbookfiles"))
        ...
        #expect(expectedToken1 == token1)
        #expect(expectedToken2 == token2)
        #expect(expectedToken3 == token3)
        #expect(expectedToken4 == token4)
        #expect(expectedToken5 == token5)
    }
    
    @Test("processBook Test") func testProcessBook() throws {
        let nodrmbook1url: URL = try #require(Bundle.module.url(forResource: "1", withExtension: "azw3", subdirectory: "testdata/einkbookfilesnodrm"))
        let nodrmbook2url: URL = try #require(Bundle.module.url(forResource: "2", withExtension: "azw3", subdirectory: "testdata/einkbookfilesnodrm"))
        let nodrmbook3url: URL = try #require(Bundle.module.url(forResource: "3", withExtension: "azw3", subdirectory: "testdata/einkbookfilesnodrm"))
        let nodrmbook4url: URL = try #require(Bundle.module.url(forResource: "4", withExtension: "azw3", subdirectory: "testdata/einkbookfilesnodrm"))
        let nodrmbook5url: URL = try #require(Bundle.module.url(forResource: "5", withExtension: "azw3", subdirectory: "testdata/einkbookfilesnodrm"))
